...
\section{Architettura Funzionale e Interfaccia Utente}\label{sec:architettura}
    ...
    \subsection{Il flusso dell'interazione}\label{subsec:flusso}
        ...
        Dal punto di vista dell'utente, l'interazione con il sistema si articola secondo un flusso strutturato, progettato per astrarre la complessità tecnica sottostante. Questo processo è schematizzato nella Figura~\ref{fig:flusso_interazione}.
