...
\usepackage{cleveref}
\usepackage{bookmark} % Risolve l'avviso e ottimizza i segnalibri
...
\begin{center}
    5 parole chiave che caratterizzano il contenuto della dissertazione:
\end{center}

\begin{tikzpicture}[overlay,remember picture,shift=(current page.center)]
\pgfmathsetseed{3}
\foreach [count=\count] \word in {Text-to-SPARQL, Knowledge Graph, LLM, Fine-tuning, Natural Language Processing} {
\node [
...
\vspace{5mm}
\LARGE{\hyperlink{cite.Tol70}{- J.R.R.Tolkien}} \\
}
\end{flushright}
...
\begingroup
    ...
    \clearpage
    \phantomsection\addtocontents{toc}{\vspace{-42pt}}
    \addcontentsline{toc}{chapter}{Elenco delle figure}
    \listoffigures

    \clearpage
    \phantomsection\addcontentsline{toc}{chapter}{Elenco delle tabelle}
    \listoftables
    
    \clearpage
    \phantomsection\addcontentsline{toc}{chapter}{Elenco delle liste}
...
\bibliographyweb{../../Documenti/refs_web}
\newpage
...
Mi era rimasta una lattina di \textit{bevanda energetica generica} ed una notte prima della revisione col prof\dots\\
Visto che i ringraziamenti sono una cosa personale, e che per chiunque non abbia idea di cosa io abbia scritto saranno l'unica cosa che andranno a leggere ho pensato di crearvi questo veloce sito dove leggerli.

\vspace*{\fill}
\begin{center}
    \qrcode[height=2.5in]{
        https://b3rt0nes.github.io/Tesi/tesi/Dissertazione/Ringraziamenti/
    }
\end{center}
\vspace*{\fill}
