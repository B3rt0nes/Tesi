...
\addplot [
    ...
    mark=*,
    mark size=1pt,
] table [col sep=comma, x=step, y=loss] {../../DataVault/llm-backend/LLM evaluation/training_log.csv};
...
\addplot [
    ...
    mark=square*,
    mark size=1pt,
] table [col sep=comma, x=step, y=eval_loss] {../../DataVault/llm-backend/LLM evaluation/training_log.csv};
