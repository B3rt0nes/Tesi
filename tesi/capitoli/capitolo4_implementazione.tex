...
\section{Stack tecnologico: Fedora e Blazegraph}\label{sec:stack}
  ...
  L'infrastruttura dati su cui si appoggia l'Quenya Query Builder è costituita da Fedora e Blazegraph. 
  ...
  \subsection{I tre layer del sistema}\label{subsec:tre_layer}
    ...
    \begin{itemize}
      ...
      \item \textbf{Applicativo (Quenya Query Builder backend, FastAPI)}: il ``cervello'' del sistema che riceve la domanda naturale, dirige il flusso:
